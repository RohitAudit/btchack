  ...
  return connected ? (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center hover:bg-[#020617]/[0.1] px-4 py-1 border  border-slate-950/25 w-fit rounded-3xl  space-x-3 text-slate-950 bg-transparent transition-colors duration-300 ease-in-out">
          <Image
            src={wallet?.icon || movementIcon}
            width={20}
            height={20}
            alt="wallet Icon"
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      ...
      >
        <DialogTrigger asChild>
          ...
          <button className="duration-300 ease-in-out hover:bg-[#020617]/[0.1] flex items-center px-4 py-1 border border-slate-950/25 w-fit rounded-3xl  space-x-2 text-slate-950">
            <Image
              src={movementIcon}
              width={20}
              height={20}
